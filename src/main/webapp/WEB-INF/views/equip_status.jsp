        		  ...
        		  jQuery("#jqGrid").jqGrid(
        		      {
        		        ...
        		        colModel : [ 
        		                     ...
        		                     {name : 'maint_reg_date',index : 'maint_reg_date',width:100,sortable : true,editable : false,formatter: 'date', editable: false, searchoptions:{readonly: 'readonly', dataInit:function(el) { $(el).datepicker();}}}, 
