...
<body>
  ...
  <div class="horiz_container">
       ...
       <div class="table_container2">
             <div class="table_head">A类易耗品使用记录</div>
             <div>
        		...
        		function pageInit(){
        		  ...
        		  jQuery("#jqGrid").jqGrid(
        		   ...
        		   $('#jqGrid').navGrid('#jqGridPager',
        	                ...
        	                afterComplete:function(xhr){      
        	                	         //提示操作结果
        	                	          $("#jqGrid").setGridParam({editurl:"editatype_use_inf_tab"}),        
        	                             alert("操作成功！");
        	                             //更新表格数据，因为之前设置了loadonce，所以datatype自动转换成了local，所以一般的reload都无效，
        	                             //必须先改回原先的数据数据类型
        	                             $("#jqGrid").setGridParam({datatype:'json', page:1}).trigger('reloadGrid');
          		  ...
          		  jQuery("#jqGrid1").jqGrid(
          		      {
          		       ...
          		       // multiselect:true,
          		        ...
          		        //生成从表
          		          atype_num_sel=id; 	
          		        $("#jqGrid").setGridParam({datatype:'json', page:1,url:"showsomeeatype_use_inf_tab?atype_num="+id}).trigger('reloadGrid');
