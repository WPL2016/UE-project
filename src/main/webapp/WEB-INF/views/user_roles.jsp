             ...
             <div class="table_head">请选择要赋予用户${username}的角色</div>   
                 ...
                 <tr><td class="blank"></td></tr>
                  <tr><td >              
	        	   ...
	        	   <div class="check_box"><input type="checkbox" id="role_select" name="role_select" value="${roles.role_id}" checked="checked"/>${roles.role_name}</div>
				  
				   </c:forEach>	
				
				   <c:forEach var="noroles" items="${noroles}" varStatus="status">
	        	  
	        	  <div class="check_box"><input type="checkbox" id="role_select"  name="role_select" value="${noroles.role_id}" />${noroles.role_name}</div>
