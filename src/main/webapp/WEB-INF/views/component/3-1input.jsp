...
<body>
<table width=1640px height="788" border="1" cellpadding="0" cellspacing="0">
  <tr bgcolor="#E1EBF5">
  ...
  <tr bgcolor="#E1EBF5">
    <th height="257" colspan="10" scope="row"><div id="linechart" style="width:100%;height:500px"></div><div id="piechart" style="width:100%;height:500px"></div></th>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr bgcolor="#E1EBF5">
