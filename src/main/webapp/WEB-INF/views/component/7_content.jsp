...
<div id="main1_0"   class="child_menu" onclick="document.all.child1_0.style.display=(document.all.child1_0.style.display =='none')?'':'none'">- 压铸设备状态</div>
       <div id="child1_0"   class="menu" style="display:none"> 
        <a href="#">- 压铸设备运行状态</a> <br> 
        <a href="#">- 压住设备维护状态</a> <br> 
       </div>    
<a href="#" >- 熔炉设备状态</a> <br> 
<a href="#">- 模具状态</a> <br> 
<a href="#">- A类易耗品状态</a> <br> 
