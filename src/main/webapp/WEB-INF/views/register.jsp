...
<script type="text/javascript">  
                   ...
                   {  
                       ...
                       if(!(register.confirm_pass.value==register.password.value))
                       {  
                           alert("确认密码不同！");  
                           return false;  
                       }  
...
<body>
  ...
  <%@ include file="./component/1_head.jsp"%> 
   ...
   <div class="blank_bf_table"></div>
        ...
        <div class="table_head">填写注册信息</div>
        <form:form id="register" method="post" modelAttribute="users" action="register" onsubmit="return validate_info(this);" >
        <table id="customers">
        <tr><td class="blank"></td><td class="blank"></td></tr>
        <tr>
          <td style="padding-left:30px">账号</td>
		 <td>		
		  		<form:input path="username" size="30"/><span style="color:red;">*</span>
		 ...
		 <td>		
		  		<form:input type="password"  path="password" size="31" /><span style="color:red;">*</span>
		  		
          </td>
         </tr>
         <tr>
           <td style="padding-left:30px">确认密码</td>
		 <td>		
		  		<input type="password"  name="confirm_pass" size="31"  /><span style="color:red;">*</span>
		 ...
		 <td>		
          ...
          <tr>
           <td></td><td><input type="submit" class="button blue" value="注册"></td>
          </tr>
           <tr><td class="blank"></td><td class="blank"></td></tr>
        </table>
        </form:form>
