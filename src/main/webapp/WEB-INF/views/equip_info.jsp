        		  ...
        		  jQuery("#jqGrid").jqGrid(
          		 ...
          		 function pageInit2(){
	          		  ...
	          		  jQuery("#jqGrid2").jqGrid(
	          		      {
	          		        url : "showequip_product_relat_tab",
	          		        datatype : "json",
	          		        colNames : [  '设备与产品关系编号','设备编号', '产品编号 ','记录人编号'],
	          		        colModel : [ 

	          		                     {name : 'equip_product_relat_num',index :'equip_product_relat_num',width : 90,align : "center",sortable :true,editable :true,key:true},
	          		                     {name : 'equip_num',index : 'equip_num',width : 150,align : "center",sortable : true,editable : true} ,
	          		                     {name : 'product_num',index : 'product_num',width : 150,align : "center",sortable : true,editable : false},             	          		                     
	          		                     {name : 'equip_product_relat_recorder_num',index : 'equip_product_relat_recorder_num',width : 150,align : "center",sortable : true,editable : false}, 
	          		                     ],
	          		        ...
	          		        prmNames: { id: "equip_product_relat_num" },
	          		        rowNum : 20,
	          		        height:180,
	          		        rowList : [ 20, 40, 60 ],
	          		        pager : '#jqGridPager2',
	          		        multiselect:true,
	          		        sortname :'equip_product_relat_num',
	          		        viewrecords : true,
	          		        sortorder : "desc",
	          		        autowidth:true,
	          		        onSelectRow : function(id) {
	          		        ...
	          		        editurl : "editequip_product_relat_tab",
