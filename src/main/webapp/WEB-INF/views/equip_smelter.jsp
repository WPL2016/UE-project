...
<body>
  ...
  <div class="horiz_container">
        ...
        <div class="table_container0">    
         <div class="table_head">熔炉设备状态</div> 
      ...
      <div class="table_container1">
           <div class="table_head">熔炉设备OEE状态</div>
           <table width="100%" height="798" border="0" cellpadding="0" cellspacing="0">
               <tr bgcolor="#E1EBF5">
                   <th height="35" colspan="10" scope="row"><div align="left"><strong><span class="style1"> 熔炉设备OEE查询</span></strong></div></th>
                   <td colspan="2">&nbsp;</td>
                   <td width="50">&nbsp;</td>
               </tr>
               <tr bgcolor="#E1EBF5">
