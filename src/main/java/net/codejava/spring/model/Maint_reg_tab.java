...
public class Maint_reg_tab {
	...
	public Maint_reg_tab(String maint_plan_obj_num,String maint_reg_cont, String maint_plan_num, String maint_reg_num,String maint_reg_per_num, @DateTimeFormat( pattern = "yyyy-MM-dd" )Date maint_reg_date) {
